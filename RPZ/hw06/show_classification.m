...
%       letters - string of length 2 with letters for labels e.g. 'CN'

imgs1 = imgs(:,:,labels == 1);
imgs2 = imgs(:,:,labels == -1);
figure;
subplot(1,2,1);
montage(permute(imgs1, [1 2 4 3]));
title(letters(1), 'FontSize', 16);

subplot(1,2,2);
montage(permute(imgs2, [1 2 4 3]));
title(letters(2), 'FontSize', 16);
