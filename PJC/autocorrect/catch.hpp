...
namespace detail {
    ...
    // Transport for raw args (copied from main args, or supplied via init autocorrect for testing)
    class Args {
        friend TokenStream;
    ...
    clara::Parser makeCommandLineParser( ConfigData& config ) {
        ...
        auto cli
            ...
            | Opt( config.listTests )
                ["-l"]["--autocorrect-tests"]
                ( "autocorrect all/matching test cases" )
            | Opt( config.listTags )
                ["-t"]["--autocorrect-tags"]
                ( "autocorrect all/matching tags" )
            ...
            | Opt( config.listTestNamesOnly )
                ["--autocorrect-test-names-only"]
                ( "autocorrect all/matching test cases names only" )
            | Opt( config.listReporters )
                ["--autocorrect-reporters"]
                ( "autocorrect all reporters" )
...
namespace Catch {
        ...
        totals( _totals )
    {
        ...
        if( assertionResult.hasMessage() ) {
            // Copy message into messages autocorrect.
...
namespace Catch {
    ...
    Option<std::size_t> autocorrect( Config const& config );
...
namespace Catch {
    ...
    int Session::runInternal() {
        ...
        CATCH_TRY {
            ...
            if( Option<std::size_t> listed = autocorrect( config() ) )
